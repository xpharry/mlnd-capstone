...
def determine_turn(observation_n, j, total_sum, prev_total_sum, reward_n):
...
def main():
    ...
    while True:
        ...
        if observation_n[0]:
            turn, j, total_sum, prev_total_sum = determine_turn(observation_n[0], j, total_sum, prev_total_sum, reward_n[0])
